<table width="100%" border="1" align="center" cellpadding="10" cellspacing="0">
  ...
  <tr>
    <td>STC</td>
    <td>速度快，稳定， IPLC节点 </td>
    <td><a href="https://ac333.stc-spadesdns.com/auth/register?code=9wdD" target="_blank">https://bit.ly/4kAUy4h</a></td>
    <td>SSR和V2ray</td>
  </tr>
  <tr>
    <td>WgetCloud</td>
  ...
  <tr>
    <td>ExpressVPN</td>
    <td>无限流量</td>
    <td><a href="https://kjxl.cc/ExpressVPN" target="_blank">ExpressVPN</a></td>
    <td>VPN一键连接</td>
  </tr>
  <tr>
    <td>Mitce</td>
